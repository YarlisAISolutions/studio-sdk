#!/usr/bin/env python3
"""
Basic usage examples for the YStudio Python SDK
"""
...
if __name__ == "__main__":
    print("🚀 Running YStudio Python SDK Examples\n")

    # Check if API key is set
    if not os.getenv("MBB_API_KEY"):
        print("❌ Please set MBB_API_KEY environment variable")
        exit(1)
